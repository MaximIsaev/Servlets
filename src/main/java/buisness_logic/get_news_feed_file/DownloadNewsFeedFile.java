...
public class DownloadNewsFeedFile {
    ...
    private final String outputFeedFolderPath = System.getenv("CATALINA_HOME") + "\\webapps\\NewsData\\NewsStorage";
    private final String outputFeedFilePath = System.getenv("CATALINA_HOME") + "\\webapps\\NewsData\\NewsStorage\\NewsFeed.xml";
