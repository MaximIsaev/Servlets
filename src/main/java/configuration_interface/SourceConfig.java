...
public class SourceConfig {
    ...
    private String newsSourceFilePath = System.getenv("CATALINA_HOME") + "\\webapps\\" + newsResourceFolderName + "\\";

    private String outputFeedFolderPath = newsSourceFilePath + newsFeedFolderName + "\\";
    private String outputFeedFilePath = outputFeedFolderPath + newsFeedFileName + ".xml";

    private String imgFolderHomePath = newsSourceFilePath + imgLinksFolderName + "\\";
