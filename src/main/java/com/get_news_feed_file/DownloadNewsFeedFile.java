...
public class DownloadNewsFeedFile {
    ...
    private static final String outputFeedFolderPath = System.getenv("CATALINA_HOME") + "\\webapps\\NewsData\\NewsStorage";
    private static final String outputFeedFilePath = System.getenv("CATALINA_HOME") + "\\webapps\\NewsData\\NewsStorage\\NewsFeed.xml";
