...
public class DownloadNewsFeedFile {
    ...
    public static String getNewsFeedsUrl() {
        return newsFeedsUrl;
    }

    public static String getOutputFeedFilePath() {
        return outputFeedFilePath;
    }

    public static File getOutputFeedFile() {
        return outputFeedFile;
    }

    public static void validateOutputFeedFile() throws IOException {
    ...
    public static void createOutputFeedFile() throws IOException {
